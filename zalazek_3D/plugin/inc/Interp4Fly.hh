...
/*!
 * \brief Modeluje polecenie dla robota mobilnego, które wymusza jego ruch do przodu oraz do góry
 *
 *  Klasa modeluje ...
 */
class Interp4Fly: public Interp4Command {
   ...
   * Dla polecenia FLY sa to predkosc horyzontalna [m/s], predkosc werdykalna [m/s] oraz przebyty dystans[m]
   */
  double  _SpeedHor;
  double _SpeedVer;
  double _Distance;
